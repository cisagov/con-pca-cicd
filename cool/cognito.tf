...
resource "aws_cognito_user_pool_client" "client" {
  ...
  callback_urls                        = ["https://${aws_lb.internal.dns_name}", "https://${aws_route53_record.sharedservices_internal_web.name}"]
  ...
  logout_urls                          = ["https://${aws_lb.internal.dns_name}", "https://${aws_route53_record.sharedservices_internal_web.name}"]
