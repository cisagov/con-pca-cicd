...
resource "aws_cognito_user_pool_client" "client" {
  ...
  callback_urls                        = ["https://${module.web_alb.alb_dns_name}", "https://${aws_route53_record.sharedservices_internal_web.name}"]
  ...
  logout_urls                          = ["https://${module.web_alb.alb_dns_name}", "https://${aws_route53_record.sharedservices_internal_web.name}"]
