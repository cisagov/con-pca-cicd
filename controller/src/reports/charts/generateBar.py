...
values = [50, 50, 50, 100, 100, 100, 200, 200, 200, 150, 150, 150, 75, 75, 75]
#values = [432,333,333, 300,360,250, 100,50,25, 50,25,15, 50,25,15]
#values = [43,33,33, 30,36,25, 10,5,2, 5,2,1, 5,2,1]
#values = [8,8,8, 3,3,2, 1,1,1, 0,2,1, 5,2,1]
#print("<html><body>")
#print("<img src='data:image/svg+xml;charset=utf-8;base64,")
#print(base64.b64encode(chartGen.generateSvg(headers,values).encode("ascii")).decode("ascii") +"'>")
