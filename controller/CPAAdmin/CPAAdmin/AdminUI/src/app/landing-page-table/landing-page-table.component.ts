...
@Component({
  ...
  styleUrls: ['./landing-page-table.component.sass']
})
export class LandingPageTableComponent implements OnInit {
  ...
  "Active"];
  subscriptionsData = [
    {"SubscriptionName":"SC-1031.Matt-Daemon.1.1","Status":"  Waiting on SRF","PrimaryContact":" Matt Daemon","Customer":"Some Company.2com","LastActionDate":" 3/26/2020","Active":true},
