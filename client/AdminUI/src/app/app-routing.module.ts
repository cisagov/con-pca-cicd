...
const routes: Routes = [
  {
    ...
    children: [
      { path: 'monthly/:id/:start_date/:local', component: MonthlyComponent },
      { path: 'cycle/:id/:start_date/:local', component: CycleComponent },
      { path: 'yearly/:id/:start_date/:local', component: YearlyComponent },
