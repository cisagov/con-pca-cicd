import { Component, AfterViewInit, Input, Output, EventEmitter, ViewEncapsulation, OnInit, OnChanges, AfterContentInit } from '@angular/core';
...
function initTimeline(timelines, items, selectedId) {
  timelines.each(function () {
    ...
    var timelineTotWidth = setTimelineWidth(timelineComponents, eventsMinDistance, selectedId);
