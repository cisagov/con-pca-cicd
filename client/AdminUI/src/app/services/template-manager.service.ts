...
export class TemplateManagerService {
  ...
  getAllTemplates() {
    console.log(
      this.http.get('http://localhost:8000/api/v1/templates', headers)
    );
  ...
  getTemlpate(uuid: string) {
    console.log(`http://localhost:8000/api/v1/template/${uuid}`);
    return this.http.get(
      `http://localhost:8000/api/v1/template/${uuid}`,
      headers
    );
